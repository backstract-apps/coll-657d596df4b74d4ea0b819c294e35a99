...
class Services(Base):
    ...
    cost = Column(Float, primary_key=False)


class Appointments(Base):
    __tablename__ = 'appointments'
    id = Column(String, primary_key=True)
    scheduled_time = Column(String, primary_key=False)
    user_id = Column(Integer, primary_key=False)
    service_id = Column(Integer, primary_key=False)
    calendar_event_id = Column(String, primary_key=False)
